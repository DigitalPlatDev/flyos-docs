...
The advanced settings allow you to control FlyOS's core functionalities, ports, SSL, resolution, startup items, and more. It is a configuration file defined by variables.    
...
```
**This configuration file is as crucial as ```/system/build.prop``` in Android. Deleting the file or any variables, or making haphazard modifications to strings, may lead to complete crash of FlyOS, rendering the container unable to start**